          ...
          <Box sx={{ flex: 1, textAlign: { xs: "center", md: "left" } }}>
            ...
            >
              <Typography
                ...
                sx={{
                  ...
                  mb: 2,
                  background:
                    "linear-gradient(45deg, #ffffff 30%, #6366f1 70%)",
                  backgroundClip: "text",
            ...
            >
              ...
              >
                ...
                user-friendly applications. Specialized in modern web
                technologies with a focus on clean code and innovative
                solutions.
              </Typography>
            </motion.div>
            ...
            >
              ...
              >
                {["React", "TypeScript", "Next.js", "Node.js", "Python"].map(
                  (skill, index) => (
                    <motion.div
                      key={skill}
                ...
                <Button
                  ...
                  onClick={() =>
                    (window.location.href =
                      "https://zahrasinamehr.com/resume.pdf")
                  }
                  sx={{
                    background:
